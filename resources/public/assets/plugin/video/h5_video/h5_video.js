$(function(){    
	...
	var icon=document.getElementById("vids");
	var vBtn = document.getElementById("vBtn");
	var volumn_img = document.getElementById("volumn_img");
	...
	/*全屏播放按钮*/
	$("#qp").click(function(){
		if (vids.requestFullscreen) {
			vids.requestFullscreen();
		} else if (vids.msRequestFullscreen) {
			vids.msRequestFullscreen();
		} else if (vids.mozRequestFullScreen) {
			vids.mozRequestFullScreen();
		} else if (vids.webkitRequestFullscreen) {
			vids.webkitRequestFullscreen();
		}
	})	
	/*收藏*/
	$("#like").click(function(){
	...
	vBtn.onmousedown = function(ev){
		...
		document.onmousemove = function(ev){
			...
			//静音改变音量图标
			if(!vids.volume){
				volumn_img.src="/assets/plugin/video/h5_video/image/volumn off.png";
			}else{
				volumn_img.src="/assets/plugin/video/h5_video/image/volumn on.png";
			}
		}
	...
	volumn_img.onmousedown = function(ev){
		if(!vids.muted){
			vids.muted = true;
			volumn_img.src="/assets/plugin/video/h5_video/image/volumn off.png";
		}else{
