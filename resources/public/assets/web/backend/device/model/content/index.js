...
$(function(){   
    ...
    $("#index_page_select").change(function() {
        ...
        if(index == "all" && page == "all" && item == "all"){
            window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/product" + dir_ + "/" + "content" + "/" + index_page_ + "";
        }
        else if(index != "all" && page == "all" && item == "all"){
            if(page_name == "all"){
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "";
            }
            else{
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_index=" + index;
            }            
        }
        else if(index == "all" && page != "all" && item == "all"){
            if(page == "index"){
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_index=" + page_name;  
            }
            else{
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_page=" + page_name;  
            }
        }
        else if(index != "all" && page != "all" && item == "all"){
            if(page == "index"){
                ...
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_index=" + index + "&i_page=" + page_name; 
            }             
        }
        else if(index == "all" && page == "all" && item != "all"){
            window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_item=" + item;
        }
        else if(index != "all" && page == "all" && item != "all"){
            if(page == "all"){
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_item=" + item;
                ...
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_index=" + index + "&i_item=" + item;
            }            
        }
        else if(index == "all" && page != "all" && item != "all"){
            if(page == "index"){
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_index=" + page_name + "&i_item=" + item;
            }
            else{
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_page=" + page_name + "&i_item=" + item;
            }              
        }
        else if(index != "all" && page != "all" && item != "all"){
            if(page == "index"){
                ...
                window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "?i_index=" + index + "&i_page=" + page_name + "&i_item=" + item;
            }   
        }
    });
    ...
    $(".index_item_add").click(function() {
        ...
        //     window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/create";
        // }
        // else if(page != "all" && item == "all"){
        //     window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/create?page=" + page;
        // }
        // else if(page == "all" && item != "all"){
        //     window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/create?item=" + item;
        // }
        // else{
        //     window.location = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/create?page=" + page + "&item=" + item;
        // } 
    ...
    function item_delete(id){
        ...
        layer.confirm('你确定要删除這個項目吗？ - id : ' + id, {
            ...
            $.ajax({
                // type:"POST",
                url:"/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/" + id,
                type: 'DELETE',
                data:{
                    '_token': $("input[name=_token]").attr("value"),
                    '_method': 'DELETE',
    ...
    function item_edit(id){        
        ...
        // window.location.href = window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/" + id + "/edit";
        window.open(window.location.protocol + "//" + $(location).attr('host') + "/backend/device/" + dir_ + "/" + "content" + "/" + index_page_ + "/edit" + "/" + id, '_blank');
