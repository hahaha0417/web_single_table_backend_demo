	...
	public static function Class_Mapping()
	{
		self::$hahaha = [
			...
			"front" => [
				...
				"index2" => [
					"_Items" => [
						"A_Index" => self::$hahaha_dir . '/app/http/models/front/index2/A_Index.php',
						"A_Item" => self::$hahaha_dir . '/app/http/models/front/index2/A_Item.php',
						"A_Temp" => self::$hahaha_dir . '/app/http/models/front/index2/A_Temp.php',
					],
				],
				"_Items" => [
				],
