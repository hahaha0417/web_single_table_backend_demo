 ...
 */
class AccountsLoginRecords extends \entities\front\AccountsLoginRecords implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'id', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'ip', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'loginTime', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'description', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'createdAt', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'updatedAt', '' . "\0" . 'entities\\front\\AccountsLoginRecords' . "\0" . 'accounts'];
        }
