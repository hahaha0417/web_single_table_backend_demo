 ...
 */
class AccountsProductsLikes extends \entities\front\AccountsProductsLikes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'entities\\front\\AccountsProductsLikes' . "\0" . 'id', '' . "\0" . 'entities\\front\\AccountsProductsLikes' . "\0" . 'like', '' . "\0" . 'entities\\front\\AccountsProductsLikes' . "\0" . 'createdAt', '' . "\0" . 'entities\\front\\AccountsProductsLikes' . "\0" . 'updatedAt', '' . "\0" . 'entities\\front\\AccountsProductsLikes' . "\0" . 'accounts', '' . "\0" . 'entities\\front\\AccountsProductsLikes' . "\0" . 'products'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccountsProductsLikes $proxy) {
