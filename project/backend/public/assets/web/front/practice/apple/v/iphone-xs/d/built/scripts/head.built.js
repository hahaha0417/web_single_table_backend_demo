require = function() {
    ...
    48: [function(t, e, r) {
        ...
        function i() {
            var t = "Apple A7 GPU" === v || "Apple A8 GPU" === v || d.os.ios && d.os.version.major <= 10 || d.os.android && y();
            return !u && !t && s("position", "sticky") && m()
        }
        var a = t("@marcom/ac-headjs"),
            ...
            f = s("position", "sticky"),
            p = s("backdrop-filter", "blur(20px)"),
            m = t("@marcom/ac-feature/canvasAvailable"),
            y = t("@marcom/ac-feature/isTablet"),
            d = t("@marcom/useragent-detect"),
            h = t("@marcom/ac-gpu-reporter").GPUReporter,
            g = new h,
            v = g.getGPU();
        a.addTests({
            "backdrop-filter": p,
            ...
            sticky: f,
            webgl: i(),
            "sprite-sheet-player": m() && !document.documentElement.classList.contains("aow")
