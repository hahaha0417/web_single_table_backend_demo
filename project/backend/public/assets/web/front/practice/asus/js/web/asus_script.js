...
(function() {
    ...
    */
    ...
    function apiheader() {
        ...
        $("#overview-top-nav").addClass('poa');
        if (!tag_id[0]) { return; }
        var offset_top = tag_id.offset().top;
        var scroll_fn = function(){
            var scrollTop = $(this).scrollTop();  
            // $('#overview-top-nav').css({
            //     'position':'absolute',
            //     'width':'100%'
            // });
            // $('.mobile #overview-top-nav').css({
            //     'position':'relative',
            //     'width':'100%'
            // });
            if (scrollTop >= offset_top){
                ...
                tag_id.stop().animate({'top': '0px'});

                if($(window).width() >= 752 && !$('body').hasClass('mobile')) {
                    tag_id.stop().animate({'top': '61px'});
                }
            }
        }
    ...
    function logoControl() {
        ...
        var position_html = '<img src="'+ logoUrl +'" alt='+ logoAlt +' style="display: inline-block;vertical-align: top">'
                           + '<div clas="desc-box" style="display: inline-block;vertical-align: bottom;text-align:left;'+ fontcolor +'">'
                            + logoDesc1
                            + logoDesc2
                            + logoDesc3
                           + '</div>';
        ...
        if(logoType == 1) {//normal layout
            if(logoPosition == 1 && logoPosition) {
                ...
                if($('#overview-top-nav').hasClass('hasMDA')) {
                ...
                position_html = '<div clas="desc-box" style="display: inline-block;vertical-align: bottom;text-align:left;'+ fontcolor +'">'
                                + logoDesc1
                                + logoDesc2
                                + logoDesc3
                               + '</div>'
                               + '<img src="'+ logoUrl +'" alt='+ logoAlt +' style="display: inline-block;vertical-align: top">';
            }
            else if(logoPosition == 3 && logoPosition){
                logoStyle = 'left: 0;margin-top:10px;';
            }

            logo_html = '<div id="brand_logo" style="position:relative;width:100%;z-index:999;'+ logoStyle +'">'
                       + position_html
                      + '</div>';
            ...
            logo_html = '<div id="brand_logo" style="position:absolute;max-width:1170px;width:100%;margin:auto;z-index:999;'+ logoStyle +'">'
                       + position_html
                      + '</div>';
            ...
            logo_html = '<div id="brand_logo" style="position:absolute;width:100%;z-index: 999;'+ logoStyle +'">'
                       + position_html
                      + '</div>';
...
var mobiles = [
    ...
    function overviewnav(){
        ...
        var run = function(){
            if (($(window).width() > 769)&&(status == true)) { clear_all(); status = false; }
            else if (($(window).width() <= 769)&&(status == false)) { start(); status = true; }
        };
        run();
        $(window).on('resize',run);
    }
