...
$(function(){   
    ...
    function add_item(){
        ...
        $.ajax({
			type:"POST",
            url:"/backend/product/dir_product/deal",
            data:{
                '_token': $("input[name=_token]").attr("value"),
                'deal': 'item',
                'method': 'add',
    ...
    function item_delete(no){
        ...
        layer.confirm('你确定要删除這個項目吗？ - no : ' + no, {
            ...
            $.ajax({
                type:"POST",
                url:"/backend/product/dir_product/delete/" + no,
                data:{
                    '_token': $("input[name=_token]").attr("value"),
                    // '_method': 'DELETE',
                    // 'method': 'select_delete',
    ...
    function item_edit(no){        
        ...
        window.open(window.location.protocol + "//" + $(location).attr('host') + "/backend/product/dir_product/edit/" + no, '_blank');
