...
$(function(){   
    ...
    var upload = window.location.protocol + "//" + $(location).attr('host') + "/backend/product/" + index_dir_[0] + "/" + index_dir_[1] + "/content/" + index_page_ + "/deal";
    {
    ...
    }
    {
        $("#index_item_image_refresh").click(function(){                         
            ...
            $.ajax({
                type:"POST",
                url:"/backend/product/" + index_dir_[0] + "/" + index_dir_[1] + "/content/" + index_page_ + "/deal",
                data:{
                    '_token': $("input[name=_token]").attr("value"),
                    'deal': 'item',
