...
$(function(){   
                ...
                <div class=\"input-group\">                 \
                    ...
                    <div id=\"index_item_panel_" + index + "\" class=\"index_item_panel\">               \
                        <div class=\"index_item_panel_content\" style=\"overflow-y:scroll;\">               \
                            ...
                            <div style=\"height:5px;\">&nbsp;</div>             \
                            <div class=\"row\">                 \
                                <div id=\"index_item_panel_create_time_" + index + "\" class=\"col\">00-00-00</div>              \
                                                    \
                            </div>                  \
                            <div class=\"row\">                 \
                                <div id=\"index_item_panel_update_time_" + index + "\" class=\"col\">00-00-00</div>                  \
                            </div>                  \
                        </div>                  \
                    </div>                      \
                </div>                          \
    ...
    function add_item(){
        ...
        // alert($(location).attr('host') + $(location).attr('pathname') + "/deal");
        $.ajax({
			type:"POST",
            url:$(location).attr('pathname') + "/deal",
            data:{
    ...
    function item_delete(id){
        // alert($(location).attr('pathname') + '/' + id);
        // var item = {'temp': 'temp',
        // };
