...
$(function() { 
	function index_item_button_prepend_detail_mouseenter(button, panel){ 
		if(is_in_iframe){ 
	...
	function index_item_button_prepend_detail_mouseleave(button, panel, event){ 
	...
	$(".index_item .index_item_button_prepend_detail").mouseenter(function(){ 
		var panel = $(this).parent().find(".index_item_panel_detail"); 
		index_item_button_prepend_detail_mouseenter(this, panel, panel); 
	}); 
	$(".index_item .index_item_button_prepend_detail").mouseleave(function(event){ 
		var panel = $(this).parent().find(".index_item_panel_detail"); 
		index_item_button_prepend_detail_mouseleave(this, panel, event); 
	}); 
}); 
 
$(function() { 
	function index_item_panel_detail_mouseleave(panel, event){ 
		e = event || window.event; 
		if(is_in_iframe){ 
	...
	$(".index_item .index_item_panel_detail").mouseleave(function(event){ 
		...
		var panel = $(this).parent().find(".index_item_panel_detail"); 
		index_item_panel_detail_mouseleave(panel, event); 
	}); 
