...
<footer class="footer">
    <div class="links">
        <div class="container">
            <a href="zh-tw" title="魔競娛樂" data-tooltip="top" class="logo"><img src="/assets/plugin_split/ment/footer/ment_footer/image/header_logo.png" alt="魔競娛樂" class="lazy img-responsive"></a>
            <ul class="reset">
