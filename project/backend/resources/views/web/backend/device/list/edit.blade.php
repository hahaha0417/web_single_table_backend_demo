...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/device/list/edit.css")}}">
        <script src="{{asset("assets/web/backend/device/list/edit.js")}}"></script>
        {{--    --}}
        <script>
            $(function(){    
            ...
            {{--  <form action="{{url("#")}}" method="post" enctype="multipart/form-data">  --}}
                ...
                @foreach($i_dir as $key => $value)    
                    <div class="form-group row">
                        <label for="index_item_dir{{$key + 1}}" class="col-sm-3 col-form-label">路徑{{$key + 1}}({{$key + 1}}層) :      </label>
                        <input type="text" class="form-control col-sm-4" id="index_item_dir{{$key + 1}}" name="index_item_dir{{$key + 1}}" placeholder="路徑" value="{{$item['dir'.($key + 1)]}}">                    
                    </div>
                    {{--  <div class="form-group row">
                        <label for="index_item_dir1" class="col-sm-3 col-form-label">路徑(1層) :      </label>
                        <input type="text" class="form-control col-sm-4" id="index_item_dir1" name="index_item_dir1" placeholder="路徑" value="0">                    
                    </div>  --}}
                @endforeach
                <hr class="hr1" />
                <div class="form-group row">
                    <label for="index_item_id" class="col-sm-3 col-form-label">識別項(ID) :      </label>
                    <input type="text" class="form-control col-sm-4" id="index_item_id" name="index_item_id" placeholder="識別項 : dir1_dir2_model_xxx" value="{{$item['id']}}">
                ...
                <div class="form-group row">
                    <label for="index_item_device" class="col-sm-3 col-form-label">設備(Device) :      </label>
                    <input type="text" class="form-control col-sm-4" id="index_item_device" name="index_item_device" placeholder="設備" value="{{$item['device']}}">
                </div>
                <div class="form-group row">
