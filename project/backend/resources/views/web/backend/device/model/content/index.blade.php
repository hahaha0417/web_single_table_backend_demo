...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/device/model/content/index.css")}}">
        <script src="{{asset("assets/web/backend/device/model/content/index.js")}}"></script>
        {{--    --}}
