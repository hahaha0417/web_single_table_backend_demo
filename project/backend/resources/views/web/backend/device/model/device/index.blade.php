...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/device/model/device/index.css")}}">
        <script src="{{asset("assets/web/backend/device/model/device/index.js")}}"></script>
        {{--    --}}
    ...
    <body>    
        <div class="index_title">
            <h1 style="font-weight:bold;">Device Device</h1>
            <hr class="hr_title" />
            <h3 style="font-weight:bold;">產品內容管理</h3>
            Product
            <hr class="hr_title" />
