...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/device/model/content/edit.css")}}">
        <script src="{{asset("assets/web/backend/device/model/content/edit.js")}}"></script>
        {{--    --}}
        <script>
            $(function(){    
