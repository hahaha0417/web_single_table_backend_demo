...
<html lang="en">
    <head>
        ...
        <script>
            ...
            var block_auto_complete_tag =  @json($block_auto_complete_tag);
            var item_auto_complete_tag =  @json($item_auto_complete_tag);
            var index_dir_ =  @json($index_dir);
            var index_model_ = "{{ $index_model }}";
            var dir_count_ = "{{ $dir_count }}";
            
        </script>   
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/device/model/dir/edit.css")}}">
        <script src="{{asset("assets/web/backend/device/model/dir/edit.js")}}"></script>
        {{--    --}}
        <script>
            $(function(){    
    ...
    <body>    
        ...
        {{csrf_field()}}
        <div id="unique_item" unique_id="{{$item['id']}}" unique_block="{{$item['block']}}" unique_item="{{$item['item']}}"></div>
        ...
        <div class="index_edit_content">            
            {{--  <form action="{{url("#")}}" method="post" enctype="multipart/form-data">  --}}
                ...
                <div class="form-group row">
                    <label for="index_item_block" class="col-sm-3 col-form-label">區塊(Block) :      </label>
                    <input type="text" class="form-control col-sm-4" id="index_item_block" name="index_item_block" placeholder="區塊" value="{{$item['block']}}">                    
                </div>                
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-4" id="index_item_id" name="index_item_id" placeholder="識別項 : class_xxx_xxx" value="{{$item['id']}}">
                ...
                <div class="form-group row"> 
                    ...
                    <label for="index_item_title_content" class="col-sm-3 col-form-label">內容(Content) :      </label>
                    <textarea class="index_item_title_content form-control col-sm-8" id="index_item_title_content" name="index_item_title_content" rows="15" cols="50" placeholder="內容">{{$item['title_content']}}</textarea>
                    <div class="w-100"></div>  
                </div>   
                <div class="form-group row">
        ...
        <div class="index_edit_content">        
            ...
            {{--  <form action="{{url("#")}}" method="post" enctype="multipart/form-data">  --}}
                ...
                <div class="form-group row">    
                    ...
                    <textarea class="index_item_item_content form-control col-sm-8" id="index_item_item_content" name="index_item_item_content" rows="15" cols="100" placeholder="內容"></textarea>
                </div>
                <div class="form-group row">
