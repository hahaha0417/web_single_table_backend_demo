...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/device/model/dir/index.css")}}">
        <script src="{{asset("assets/web/backend/device/model/dir/index.js")}}"></script>
        {{--    --}}
    ...
    <body>    
        <div class="index_title">
            <h1 style="font-weight:bold;">Device Dir</h1>
            <hr class="hr_title" />
