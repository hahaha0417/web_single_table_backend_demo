...
<html lang="en">
    ...
    <body style="background:rgba(255,210,210,1);" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <div style="background:rgba(190,255,190,1);">
                ...
                <h1>
                    輔助
                    <a class="btn btn-dark btn-lg active" href="/backend/aid/env">
                        環境
                    </a>
        ...
        <div class="form-group row" data-name="{{ $name }}">
            ...
            <div class="form-group row">
                <button type="button" data-command="<?php echo define_env::LOCAL; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">本地</button>
                <button type="button" data-command="<?php echo define_env::SERVER; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">Server</button>
            </div>

            {{-- <div class="form-group row">
                <button type="button" class="setting_reset_setting btn btn-dark col-lg-1 btn_item">重置Setting</button>
            </div> --}}
        </div>
        {{-- ------------------------------------------------------------------------------ --}}
        ...
        <div class="form-group row" data-name="{{ $name }}">
            ...
            <div class="form-group row">
                <button type="button" data-command="<?php echo define_env::DEMO; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">
                    展示用
                </button>
                <button type="button" data-command="<?php echo define_env::MIGRATE; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">
                    初始化用
                </button>
                <button type="button" data-command="<?php echo define_env::PUBLISH; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">
                    發佈用
                </button>
            </div>
        </div>
        ...
        <script>
            $(function(){
                $(".<?php echo key::COMMAND; ?>").click(function() {
                    ...
                    aid_.Command(item_.ENV, command_);
