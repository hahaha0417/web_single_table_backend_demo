    ...
    <body style="background:rgba(255,210,210,1);" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <div style="background:rgba(190,255,190,1);">
                ...
                <h1>
                    ...
                    <a class="btn btn-dark btn-lg active" href="/backend/aid/tool">
                        工具
                    </a>
        ...
        <div class="form-group row" data-name="{{ $name }}">
            ...
            <div class="form-group row">
                <button type="button" data-command="<?php echo define_tool::GENERATE_DB_FIELD_CONST; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">產生DB欄位常數</button>
            </div>
        </div>
        ...
        <script>
            $(function(){
                $(".<?php echo key::COMMAND; ?>").click(function() {
                    ...
                    aid_.Command(item_.TOOL, command_);
