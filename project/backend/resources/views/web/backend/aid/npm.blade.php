    ...
    <body style="background:rgba(255,210,210,1);" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div style="background:rgba(190,255,190,1);">
                ...
                <h1>
                    ...
                    <a class="btn btn-dark btn-lg active" href="/backend/aid/npm">
                        Npm
                    </a>
                </h1>
                <hr />
        ...
        <div class="form-group row" data-name="{{ $name }}">
            ...
            <div class="form-group row">
                <button type="button" data-command="<?php echo define_npm::PLUGIN_INSTALL; ?>" class="<?php echo key::COMMAND; ?> dump_autoload btn btn-dark col-lg-1 btn_item">
                    Npm Plugin 安裝
                </button>
                <button type="button" data-command="<?php echo define_npm::PLUGIN_UPDATE; ?>" class="<?php echo key::COMMAND; ?> dump_autoload btn btn-dark col-lg-1 btn_item">
                    Plugin 安裝
                </button>
            </div>
        </div>
        ...
        <script>
            $(function(){
                $(".<?php echo key::COMMAND; ?>").click(function() {
                    ...
                    aid_.Command(item_.NPM, command_);
