    ...
    <body style="background:rgba(255,210,210,1);" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <div style="background:rgba(190,255,190,1);">
                ...
                <h1>
                    ...
                    <a class="btn btn-dark btn-lg active" href="/backend/aid/migrate">
                        Migrate
                    </a>
        ...
        <div class="form-group row">
            <button type="button" data-command="<?php echo define_migrate::MIGRATE_RESET; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">重置</button>
            <button type="button" data-command="<?php echo define_migrate::MIGRATE_REFRESH; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">刷新</button>
            <button type="button" data-command="<?php echo define_migrate::MIGRATE_MIGRATE; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">建立</button>
            <button type="button" data-command="<?php echo define_migrate::MIGRATE_ROLLBACK; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">刪除</button>
        </div>
        ...
        <div class="form-group row">
            <button type="button" data-command="<?php echo define_migrate::SEED_DEMO; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">展示用</button>
            <button type="button" data-command="<?php echo define_migrate::SEED_MIGRATE; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">初始化用</button>
            <button type="button" data-command="<?php echo define_migrate::SEED_PUBLISH; ?>" class="<?php echo key::COMMAND; ?> btn btn-dark col-lg-1 btn_item">發佈用</button>
        </div>
        ...
        <script>
            $(function(){
                $(".<?php echo key::COMMAND; ?>").click(function() {
                    ...
                    aid_.Command(item_.MIGRATE, command_);
