...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/product/model/product/index.css")}}">
        <script src="{{asset("assets/web/backend/product/model/product/index.js")}}"></script>
        {{--    --}}
