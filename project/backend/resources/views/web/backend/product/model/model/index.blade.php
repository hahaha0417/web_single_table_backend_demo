...
<html lang="en">
    <head>
        ...
        <script>
            ...
            var block_list_ = {!! $block_list !!};
            var item_list_ = {!! $item_list !!};
            
        </script>  
         
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/product/model/model/index.css")}}">
        <script src="{{asset("assets/web/backend/product/model/model/index.js")}}"></script>
        {{--    --}}
    ...
    <body>    
        <div class="index_title">
            <h1 style="font-weight:bold;">Product Class</h1>
            <hr class="hr_title" />
            <h3 style="font-weight:bold;">模型內容管理</h3>
            Model
            <hr class="hr_title" />
                    ...
                    <div id="index_item_add_panel" class="index_item_add_panel">
                        <div class="index_item_add_panel_content">
                            <div class="form-group row">
                                <label for="index_item_add_panel_block" class="col-sm-3 col-form-label">區塊(Block) :      </label>
                                <input type="text" class="form-control col-sm-4" id="index_item_add_panel_block" name="index_item_add_panel_block" placeholder="區塊">
                            </div>
                            <div class="form-group row">
                                <label for="index_item_add_panel_item" class="col-sm-3 col-form-label">項目(Item) :      </label>
                                <input type="text" class="form-control col-sm-4" id="index_item_add_panel_item" name="index_item_add_panel_item" placeholder="項目">
                            </div>
                            <div class="form-group row">
                                <label for="index_item_add_panel_id" class="col-sm-3 col-form-label"><span style="color:red;">*</span>識別項(Id) :      </label>
                                <input type="text" class="form-control col-sm-4" id="index_item_add_panel_id" name="index_item_add_panel_id" placeholder="識別項">
                            ...
                            <div class="form-group row">
                                <label for="index_item_add_panel_name" class="col-sm-3 col-form-label">名稱(Name) :      </label>
                                <input type="text" class="form-control col-sm-4" id="index_item_add_panel_name" name="index_item_add_panel_name" placeholder="名稱">
                            </div>
                                ...
                                <tr id="index_item_{{$loop->index}}" class="index_item" item_id="{{$value['id']}}" index="{{$loop->index}}">                                
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input id="index_item_name_{{$loop->index}}" type="text" class="index_item_name form-control" placeholder="名稱" value="{{$value['name']}}">
                                            <div id="index_item_name_prepend_{{$loop->index}}" class="input-group-prepend index_item_name_prepend">
                                            ...
                                            <div id="index_item_panel_{{$loop->index}}" class="index_item_panel">
                                                <div class="index_item_panel_content" style="overflow-y:scroll;">                                                                                              
                                                    <div class="row">
                                                        <label for="index_item_panel_block_{{$loop->index}}" class="col-sm-3 col-form-label">區塊 : </label>
                                                        <div class="col">
                                                            <input style="width:530px;" id="index_item_panel_block_{{$loop->index}}" style="" type="text" class="index_item_panel_block form-control" placeholder="區塊" value="{{$value['block']}}">  
                                                        </div>
                                                    </div>
                                    ...
                                    <td>
                                        <div class="" >                                                                              
                                            ...
                                            <div id="index_item_image_upload_{{$loop->index}}" class="index_item_image_upload" style="margin-right:15px;display:inline-block;" name="index_item_image_upload_0" type="file"></div>        
                                        </div>
                                    </td>
                                    <td>
                                        <div class="" >  
