...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/backend/product/model/class/index.css")}}">
        <script src="{{asset("assets/web/backend/product/model/class/index.js")}}"></script>
        {{--    --}}
    ...
    <body>    
        <div class="index_title">
            ...
            <hr class="hr_title" />
            <h3 style="font-weight:bold;">分類內容管理</h3>
            Class
            <hr class="hr_title" />
