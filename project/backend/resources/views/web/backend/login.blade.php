...
$hahaha_option = hahaha_option::Instance();
    ...
    <body>
        <div class="login_box">
            <div class="login_content">
                <h1>{{__($hahaha_option->Web->Name)}}</h1>
                <h2>{{__($hahaha_option->Web->Description)}}</h2>
                ...
                <div id="login_form" class="login_form">
                    ...
                    <p>
                        <a href="{{url("/")}}">{{__("backend.home")}}</a>
                        &copy; {{__($hahaha_option->Web->Copyright->Date)}} Powered by
                        <a href="{{url("/")}}" target="_blank">{{__($hahaha_option->Web->Author)}}</a>
                    </p>
                </div>
            </div>
        </div>
