...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset("assets/web/front/common/home/main_home/future/main_home_future.css")}}">
        <script src="{{asset("assets/web/front/common/home/main_home/future/main_home_future.js")}}"></script>
