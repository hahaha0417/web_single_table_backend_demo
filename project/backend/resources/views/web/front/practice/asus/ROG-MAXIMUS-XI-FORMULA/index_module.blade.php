...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset("assets/web/front/practice/asus/ROG-MAXIMUS-XI-FORMULA/index_module.css")}}">
        <script src="{{asset("assets/web/front/practice/asus/ROG-MAXIMUS-XI-FORMULA/index_module.js")}}"></script>
