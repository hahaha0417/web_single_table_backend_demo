...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/front/product/model/overview/main_overview/main_model_overview.css")}}">
        <script src="{{asset("assets/web/front/product/model/overview/main_overview/main_model_overview.js")}}"></script>
