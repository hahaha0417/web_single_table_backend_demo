...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset("assets/web/front/ha/ha_media_100/manual/manual.css")}}">
        <script src="{{asset("assets/web/front/ha/ha_media_100/manual/manual.js")}}"></script>
