...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/front/device/model/feature/content/main_content/main_model_feature_content.css")}}">
        <script src="{{asset("assets/web/front/device/model/feature/content/main_content/main_model_feature_content.js")}}"></script>
