...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/front/device/model/feature/main_feature/main_model_feature.css")}}">
        <script src="{{asset("assets/web/front/device/model/feature/main_feature/main_model_feature.js")}}"></script>
        ...
        <div id="content" >            
            ...
            <div id="main_box">
                <div id="model_feature_content">  
                    @if(!empty($item))              
                        <iframe class="content_frame" id="feature_content_frame" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="{{url('device/').'/'.$dir.'model/'.$model.'/feature/'.$item.'/content'}}">
                        </iframe> 
                    @else
                        <iframe class="content_frame" id="feature_content_frame" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="{{url('device/').'/'.$dir.'model/'.$model.'/feature/'.'content'}}">
                        </iframe> 
                    @endif
                </div>
                {{-- <div id="model_feature_content">                
                        <iframe class="content_frame" id="feature_content_frame2" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="{{url("device/aoi/hahahalib/feature/overview/content")}}">
                        </iframe> 
                </div>
                <div id="model_feature_content">                
                        <iframe class="content_frame" id="feature_content_frame3" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="{{url("device/aoi/hahahalib/feature/overview/content")}}">
                        </iframe> 
                </div> --}}
            </div>
            {{--  <div id="right_box">  --}}
