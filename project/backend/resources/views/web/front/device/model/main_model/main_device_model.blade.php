...
<html lang="en">
    <head>
        ...
        {{--    --}}
        <link rel="stylesheet" href="{{asset("assets/web/front/device/model/main_model/main_device_model.css")}}">
        <script src="{{asset("assets/web/front/device/model/main_model/main_device_model.js")}}"></script>
    ...
    <body>    
        ...
        {{--  間隔  --}}
        <div class="device_model_space">
            <br><br>
        </div>

        <div class="css_nav device_model_title_nav">
            <div class="head_bg">
                <div class="cl top_h navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="navbar-nav navbar-expand-lg navbar-dark bg-dark ml-3" id="">                                       
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#device_model_title_nav_bar" 
                            aria-controls="device_model_title_nav_bar" aria-expanded="false" aria-label="Toggle navigation">
                            <!-- .navbar-toggler-icon 漢堡式選單Icon -->
                            <span class="navbar-toggler-icon"></span>
                        </button>           
                    </div> 
                    <div class="nov m_l l collapse navbar-collapse navbar-ex1-collapse" id="device_model_title_nav_bar">
        ...
        <div class="device_model_content">
