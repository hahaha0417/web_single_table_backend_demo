...
Route::group(['middleware' => ['web', 'backend.login'], 'prefix' => 'backend', 'namespace' => 'Backend'], function() {
    ...
    // 輔助
    // --------------------------------------
    Route::get('/aid', 'IndexController@aid');
    Route::get('/aid/env', 'IndexController@aid_env');
    Route::get('/aid/tool', 'IndexController@aid_tool');
    Route::get('/aid/composer', 'IndexController@aid_composer');
    Route::get('/aid/git', 'IndexController@aid_git');
    Route::get('/aid/npm', 'IndexController@aid_npm');
    Route::get('/aid/migrate', 'IndexController@aid_migrate');
    // --------------------------------------
    // 預設頁面路徑
